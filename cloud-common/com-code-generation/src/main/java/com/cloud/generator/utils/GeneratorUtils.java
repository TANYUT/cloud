...
public class GeneratorUtils {
    ...
    private static final String INDEX_JS_VM = "index.js.vm";
    ...
    public static void generatorCode(GenConfig genConfig, Map<String, String> table,
        ...
        map.put("ctime", DateUtil.now());
        map.put("secondModuleName", toLowerCaseFirstOne(className));
        map.put("tablePrefix", config.getString("tablePrefix"));
    ...
    private static String getFileName(String template, String className, String packageName, String moduleName) {
        String packagePath = "cloud" + File.separator + "src" + File.separator + "main" + File.separator + "java" + File.separator;
        ...
        if (template.contains(MAPPER_XML_VM)) {
            return"cloud" + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator + "mapper" + File.separator + className + "Mapper.xml";
        }
        ...
        if (template.contains(INDEX_VUE_VM)) {
            return "cloud" + File.separator + "src" + File.separator + "views" +
                    File.separator + moduleName + File.separator + toLowerCaseFirstOne(className) + File.separator + "index.vue";
        }

        if (template.contains(INDEX_JS_VM)) {
            return "cloud" + File.separator + "src" + File.separator + "api" + File.separator + moduleName + File.separator + toLowerCaseFirstOne(className) + ".js";
        }
